...
plt.plot(right, test_38_s1_r, color="red", label="38, s=1")
plt.plot(left[left < -2.5], test_40_s0_l, color="cyan", label="40")
plt.plot(right, test_40_s0_r, color="orange", label= "40")
plt.plot(right, test_55_s1_r, color="green", label="55")
plt.plot(left, test_38_s3_l, color="pink", label="38, s=3")
plt.plot(left, test_38_s2_l, color="black", label="38, s=2")
plt.plot(left[left < -6.], test_39_s1_l, color="brown", label="39, s=1")
plt.yscale('log')
